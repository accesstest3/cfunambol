...
/**
 * Used to start the process to modify a SyncSouce
 *
 *
 * @version $Id: UpdateSyncSource.java,v 1.5 2007-11-28 10:28:18 nichele Exp $
 */

public class UpdateSyncSource extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("UpdateSyncSource - performAction");
        ...
        SyncSourceNode node = (SyncSourceNode)nodes[0];
        try {
            ExplorerUtil.getSyncAdminController().getSyncSourcesController().
                startUpdateSourceProcess(node);
