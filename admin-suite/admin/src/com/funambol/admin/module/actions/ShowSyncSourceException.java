...
/**
 * Used to show the error associated to the SyncSourceException
 *
 *
 * @version $Id: ShowSyncSourceException.java,v 1.5 2007-11-28 10:28:18 nichele Exp $
 */

public class ShowSyncSourceException extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("ShowSyncSourceException - performAction");
        ...
        SyncSourceExceptionNode node = (SyncSourceExceptionNode)nodes[0];

        ExplorerUtil.getSyncAdminController().getSyncSourcesController().
            showSyncSourceException(node);
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_EDIT_NAME);
    }
}
