...
/**
 * This action is invoked when a connector should be configured.
 *
 * @version $Id: EditConnector.java,v 1.5 2007-11-28 10:28:18 nichele Exp $
 */

public class EditConnector extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("ConfigureAction - performAction");
        ...
        ConnectorNode node = (ConnectorNode)nodes[0];
        try {
            ExplorerUtil.getSyncAdminController().getConnectorController().editConnector(node);
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_EDIT_CONNECTOR);
    }
}
