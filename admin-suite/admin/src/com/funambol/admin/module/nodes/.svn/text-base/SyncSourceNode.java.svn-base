...
import com.funambol.admin.module.actions.UpdateSyncSource;
...
/**
 * Node associated to SyncSource.<br/>
 * With this node user can access syncSource's properties and can perform some actions
 * associated to the syncSource like modify and delete.
 *
 * @version $Id: SyncSourceNode.java,v 1.5 2007-11-28 10:28:17 nichele Exp $
 */
public class SyncSourceNode extends BeanNode implements SyncSourceEventListener, Refreshable {

    // ------------------------------------------------------------ Private data

    /** Sync4jModule that contains the syncSource associated to this SyncSourceNode */
    ...
    /** Sync4jConnector that contains the syncSource associated to this SyncSourceNode */
    ...
    /** Sync4jSourceType of the syncSource associated to this SyncSourceNode */
    ...
    /** SyncSource associated to this SyncSourceNode */
    private SyncSource syncSource = null;

    /**
     * Returns property syncSource
     */
     ...
     */
    public SyncSourceNode(Sync4jModule Sync4jModule, Sync4jConnector connector,
                          Sync4jSourceType sync4jSourceType, SyncSource syncSource) throws
        IntrospectionException {
        super(new Object());

        setIconBaseWithExtension(Constants.ICON_SYNCSOURCE_NODE);
    ...
    public Action[] getActions(boolean context) {
        ...
        return new SystemAction[] {
            ...
            null,
            NodeAction.get(UpdateSyncSource.class),
            null,
     ...
     * @return <code>UpdateSyncSource</code> action
     */
    public Action getPreferredAction() {
        return NodeAction.get(UpdateSyncSource.class);
    }
    ...
    public void syncSourceUpdated(SyncSource syncSource) {
        if (syncSource.getSourceURI().equals(this.syncSource.getSourceURI())) {
            this.syncSource = syncSource;
            setName(syncSource.getSourceURI());
            setDisplayName(syncSource.getSourceURI());
        }
    }
