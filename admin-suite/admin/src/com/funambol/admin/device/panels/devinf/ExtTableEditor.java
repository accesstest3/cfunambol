...
/**
 * Cell Editor and Tabel cell editor implementations for ext table
 *
 * @version $Id: ExtTableEditor.java,v 1.4 2007-11-28 10:28:17 nichele Exp $
 */
public class ExtTableEditor 
extends AbstractCellEditor
implements TableCellEditor, ActionListener {

    // --------------------------------------------------------------- Constants
    protected static final String ACTION_EDIT = "ACTION_EDIT";
    
    // ------------------------------------------------------------ Private data
    private JButton button;
    private ExtValuesDialog dialog;
     ...
     * the ext editing dialog.
     *
     * @param exts Ext values of the devinf
     */
    public ExtTableEditor(ArrayList exts) {
        this.exts = exts;
        button = new JButton();
        button.setActionCommand(ACTION_EDIT);
        button.addActionListener(this);
        dialog = ExtValuesDialog.createDialog(button, true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (ACTION_EDIT.equals(e.getActionCommand())) {
            ...
            //bring up the dialog.
            dialog = ExtValuesDialog.createDialog(button, true);
            dialog.setExt((Ext) exts.get(currentRow.intValue()));
