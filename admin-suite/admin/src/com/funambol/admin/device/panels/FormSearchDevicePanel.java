...
/**
 * Create the panel used for searching device.<br>
 * The panel includes all the fields associated to a device:
 * deviceID, Type, Description.
 *
 * @version $Id: FormSearchDevicePanel.java,v 1.6 2007-11-28 10:28:17 nichele Exp $
 **/
public class FormSearchDevicePanel extends JPanel {
    ...
    private void init() throws Exception {
        ...
        jLDescription.setBounds(new Rectangle(13, 103, 76, 20));
        jLDescription.setText(Bundle.getMessage(Bundle.DEVICE_PANEL_DESCRIPTION) + " :");
        jCBDescription.setBounds(new Rectangle(91, 103, 92, 20));

        jTFDescription.setBounds(new Rectangle(191, 103, 151, 20));

        // set properties of label and textfield referred to TYPE including position
        jLType.setBounds(new Rectangle(13, 78, 76, 20));
        jLType.setText(Bundle.getMessage(Bundle.DEVICE_PANEL_TYPE) + " :");
        jCBType.setBounds(new Rectangle(91, 78, 92, 20));

        jTFType.setBounds(new Rectangle(191, 78, 151, 20));
