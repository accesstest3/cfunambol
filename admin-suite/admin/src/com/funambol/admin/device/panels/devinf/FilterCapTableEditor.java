...
/**
 * Cell Editor and Tabel cell editor implementations for Filter Cap table
 *
 * @version $Id: FilterCapTableEditor.java,v 1.4 2007-11-28 10:28:17 nichele Exp $
 */
public class FilterCapTableEditor 
extends AbstractCellEditor
implements TableCellEditor, ActionListener {

    // --------------------------------------------------------------- Constants
    protected static final String ACTION_EDIT = "ACTION_EDIT_FILTERCAP";
    
    // ------------------------------------------------------------ Private data
    /**
     * the button that bring up the dialog for filterCap properties
     */
    private JButton button;
    /**
     * reference to the filterCap properties dialog
     */
    private FilterCapDialog dialog;
    /**
     * currently selected row in filterCap table
     */
    private Integer currentRow;
    /**
     * the list with the filterCaps displayed in the table
     */
     ...
     * the filterCap editing dialog.
     *
     * @param filterCaps FilterCap values of the devinf
     */
    public FilterCapTableEditor(ArrayList filterCaps) {
        this.filterCaps = filterCaps;
        button = new JButton();
        button.setActionCommand(ACTION_EDIT);
        button.addActionListener(this);
        dialog = FilterCapDialog.createDialog(button, true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (ACTION_EDIT.equals(e.getActionCommand())) {
            ...
            //bring up the dialog.
            dialog.setFilterCap(
                    (FilterCap) filterCaps.get(currentRow.intValue()));
