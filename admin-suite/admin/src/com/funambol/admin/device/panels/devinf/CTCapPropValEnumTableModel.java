...
/**
 * Table model for the table with the ctcap properties valEnum
 *
 * @version $Id: CTCapPropValEnumTableModel.java,v 1.5 2007-11-28 10:28:17 nichele Exp $
 */
public class CTCapPropValEnumTableModel extends AbstractTableModel {
    // --------------------------------------------------------------- Constants
    private final static String[] columns = {" "};

    // ------------------------------------------------------------ Private data
    /**
     * the list of values to be displayed by the table
     */
    ...
    /**
     * Creates a table model for the table with the ctcap properties valEnum
     *
     * @param prop the ctCap property for witch the values will be displayed
     */
    public CTCapPropValEnumTableModel(Property prop) {
        this.valEnum = prop.getValEnums();
    }
    ...
    public void remVal(int row) {
        if (row >= 0) {
            int answer = JOptionPane.showConfirmDialog(
                    null, Bundle.getMessage(
                            Bundle.MSG_DELETE_CTCAPPROPVAL),
                    Bundle.getMessage(
                            Bundle.MSG_DELETE_CTCAPPROPVAL_TITLE),
