...
/**
 * Used to start the process to create a new device.
 *
 *
 * @version $Id: CreateDevice.java,v 1.5 2007-11-28 10:28:18 nichele Exp $
 *
 **/
public class CreateDevice extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("CreateDevice - performAction");
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_ADD_DEVICE_NAME);
    }
}
