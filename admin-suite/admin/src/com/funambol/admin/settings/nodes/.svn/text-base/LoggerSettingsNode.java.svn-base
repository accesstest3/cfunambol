...
import com.funambol.admin.settings.actions.EditLogger;
import com.funambol.admin.settings.actions.DummyEditLogger;
import com.funambol.admin.util.Constants;

/**
 * Node associated to the server logger panel.<br/>
 * Through this node, it is possible to manage logger settings.
 *
 * @version $Id: LoggerSettingsNode.java,v 1.8 2007-11-28 10:28:17 nichele Exp $
 */
public class LoggerSettingsNode
extends BeanNode
implements Refreshable {
    ...
    /**
     * The LoggerConfiguration object this node represents
     */
     ...
     */
    public LoggerSettingsNode(LoggerConfiguration config)
    throws java.beans.IntrospectionException{
        super(config);

        setIconBaseWithExtension(Constants.ICON_LOGGER_SETTINGS_NODE);
    ...
    public Action getPreferredAction() {
        return NodeAction.get(EditLogger.class);
    }
    /**
    ...
    public Action[] getActions(boolean context) {
        return new Action[] {
                   NodeAction.get(EditLogger.class   ),
     ...
     */
    public void refresh() {
        ((LoggersSettingsNode)getParentNode()).refresh();
    }
