 ...
 *
 * @version $Id: LoggingSettingsChildren.java,v 1.6 2007-11-28 10:28:17 nichele Exp $
 */
public class LoggingSettingsChildren
extends Children.Array {
    ...
    private void loadChildren() {
        ...
        Node[] nodes = {
            new LoggersSettingsNode(),
            new AppendersSettingsNode()
        };
