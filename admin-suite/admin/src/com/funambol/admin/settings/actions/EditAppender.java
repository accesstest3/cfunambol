...
/**
 * Action used to show the appender editing panel.
 *
 * @version $Id: EditAppender.java,v 1.4 2007-11-28 10:28:19 nichele Exp $
 */
public class EditAppender extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("EditAppender - performAction");
        ...
        AppenderSettingsNode node = (AppenderSettingsNode)nodes[0];
        try {
            ExplorerUtil.getSyncAdminController()
                        .getServerSettingsController()
                        .startAppenderEditing(node);
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_EDIT);
    }
}
