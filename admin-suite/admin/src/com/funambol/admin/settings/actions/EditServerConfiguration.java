 ...
 * 
 *
 * @version $Id: EditServerConfiguration.java,v 1.5 2007-11-28 10:28:19 nichele Exp $
 *
 **/
public class EditServerConfiguration extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("EditServerConfiguration - performAction");
        ...
        ServerSettingsNode node = (ServerSettingsNode)nodes[0];
        try {
