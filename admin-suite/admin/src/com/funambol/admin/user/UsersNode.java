...
/**
 * Node associated to the users in the explorer.<br/>
 * Through this node, it is possible manage user properties and perform some
 * actions like create and search the users.
 *
 *
 * @version $Id: UsersNode.java,v 1.6 2007-11-28 10:28:19 nichele Exp $
 */
public class UsersNode extends BeanNode {
     ...
     */
    public UsersNode(String name) throws java.beans.IntrospectionException {
        super(name);
        setIconBaseWithExtension(Constants.ICON_USERS_NODE);
        setName(name);
        setDisplayName(name);
    }
