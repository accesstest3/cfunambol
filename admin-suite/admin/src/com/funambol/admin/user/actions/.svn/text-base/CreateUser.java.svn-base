...
package com.funambol.admin.user.actions;
...
/**
 * Used to start the process to create a new User.
 *
 *
 * @version $Id: CreateUser.java,v 1.5 2007-11-28 10:28:18 nichele Exp $
 *
 **/
public class CreateUser extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("CreateUser - performAction");
        ...
        String role = nodes[0].getDisplayName();
        try {
            ExplorerUtil.getSyncAdminController().getUsersController().startNewUserProcess(role);
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_ADD_USER_NAME);
    }
}
