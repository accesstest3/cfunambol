...
import com.funambol.admin.about.AboutDialog;
import com.funambol.admin.util.Bundle;

/**
 * Action used to create the About Panel
 *
 * @version $Id: AboutAction.java,v 1.6 2007-11-28 10:28:16 nichele Exp $
 */
public class AboutAction extends CallableSystemAction{
    ...
    /**
     * Creates a new instance of AboutActionTEMP
     */
    public AboutAction() {
    }
    // ------------------------------------------------------------ Public Methods
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_ABOUT);   
    }
