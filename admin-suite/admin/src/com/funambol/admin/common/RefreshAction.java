...
package com.funambol.admin.common;
...
/**
 * Generic action used to refresh node's children.
 *
 * @see Refreshable
 *
 * @version $Id: RefreshAction.java,v 1.5 2007-11-28 10:28:19 nichele Exp $
 */
...
public class RefreshAction extends ExplorerAction {
    ...
    public void performAction(Node[] nodes) {
        Log.debug("RefreshAction - performAction");
        ...
        Refreshable nodeRefreshable = (Refreshable)nodes[0];
        nodeRefreshable.refresh();
    }
    ...
    public String getName() {
        return Bundle.getMessage(Bundle.ACTION_REFRESH);
    }
}
