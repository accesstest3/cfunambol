 ...
 *
 *
 * @version $Id: Language.java,v 1.2 2007-12-22 14:01:20 nichele Exp $
 */
public class Language {

    //---------------------------------------------------------- Constants

    public final static String LANGUAGE_FILE    = "language_us" ;
    public final static Locale LANGUAGE_LOCALE  = Locale.US     ;
