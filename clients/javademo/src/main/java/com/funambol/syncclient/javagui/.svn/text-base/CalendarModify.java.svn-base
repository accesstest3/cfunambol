...
/**
 * The calendar modification panel.
 *
 * @version $Id: CalendarModify.java,v 1.2 2007-12-22 14:01:20 nichele Exp $
 */
...
implements ActionListener, ConfigurationParameters {
     ...
     */
    public CalendarModify(MainWindow mw) {
        ...
        title = new Label(ln.getString("calendar_modify"));
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (evt.getActionCommand().equals("ok")) {
            ...
            isAllRight = cfields.areFieldsRight();
    ...
    /**
     * Sets the fields with the values contained in the specified Calendar 
     * object and the checkbox with the specified type.
     *
     * @param calendar the Calendar object which is the source of the values
     */
    protected void fillFields(Calendar calendar) {
        form.setFields(calendar);
    }

    //---------------------------------------------------------- Private methods

    /**
     * Saves the modified calendar.
     */
    private void saveCalendar() {
        mw.writeModCalendar(form.getFields(), mw.getCurrentIndex().intValue());
        mw.show(KEY_CALENDARLIST);
    }
