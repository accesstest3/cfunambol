...
import com.funambol.tools.test.PostSyncML;
 ...
 *
 *
 * @version $Id: TestSyncMLTask.java,v 1.2 2007-11-28 10:52:31 nichele Exp $
 */
public class TestSyncMLTask extends TestSyncMLBaseTask {
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            // loading the xml messages to be able to modify these files (for example
        ...
        String[] msgFiles = dir.list(new TestMessageFileFilter("xml"));
        //
