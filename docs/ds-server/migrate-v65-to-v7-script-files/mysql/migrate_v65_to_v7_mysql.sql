...
ALTER TABLE fnbl_email_inbox ADD COLUMN token varchar(200) binary;

--
-- Foundation connector
--
ALTER TABLE fnbl_pim_calendar ADD COLUMN dstart_tz   varchar(255) binary;
ALTER TABLE fnbl_pim_calendar ADD COLUMN dend_tz     varchar(255) binary;
ALTER TABLE fnbl_pim_calendar ADD COLUMN reminder_tz varchar(255) binary;
