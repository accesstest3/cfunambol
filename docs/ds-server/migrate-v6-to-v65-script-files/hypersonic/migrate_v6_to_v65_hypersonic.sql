...
ALTER TABLE fnbl_pim_listener_registry ALTER COLUMN username varchar(255);
...
ALTER TABLE fnbl_email_account ALTER COLUMN account_id bigint;
ALTER TABLE fnbl_email_cache   ALTER COLUMN principal  bigint;
ALTER TABLE fnbl_email_cache   ALTER COLUMN messageid  varchar(700);
ALTER TABLE fnbl_email_folder  ALTER COLUMN principal  bigint;
ALTER TABLE fnbl_email_sentpop ALTER COLUMN principal  bigint;
ALTER TABLE fnbl_email_sentpop ALTER COLUMN messageid  varchar(700);
ALTER TABLE fnbl_email_inbox   ALTER COLUMN messageid  varchar(700);
