...
/**
 * Represents an exception that occurs handing the device connections
 * @version $Id: DeviceConnectionException.java,v 1.2 2007-11-28 11:26:15 nichele Exp $
 */
public class DeviceConnectionException extends Exception {

    /**
     * Creates a new instance of <code>DeviceConnectionException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>DeviceConnectionException</code> with the
