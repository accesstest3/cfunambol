...
/**
 *
 * @version $Id: ReceiverException.java,v 1.2 2007-11-28 11:26:15 nichele Exp $
 */
public class ReceiverException extends Exception {

    /**
     * Creates a new instance of <code>ReceiverException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>ReceiverException</code> with the
