...
/**
 *
 * @version $Id: MinaClientException.java,v 1.2 2007-11-28 11:26:14 nichele Exp $
 */
public class MinaClientException extends RuntimeException {

    /**
     * Creates a new instance of <code>MinaClientException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>MinaClientException</code> with the
