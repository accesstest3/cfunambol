 ...
 */
public class NotAuthenticated extends Status {

    // --------------------------------------------------------------- Constants
    public static final String CMD_NAME    = "NOT_AUTHENTICATED";
    ...
    /**
     * Creates a new instance of <code>NotAuthenticated</code> status command with
     * nonce to use in the next authentication phase.
     *
     * @param nonce the nonce
     */
    public NotAuthenticated(byte[] nonce) {
        this.nonce = nonce;
    }
    ...
    public boolean deepequals(Object obj) {
        ...
        NotAuthenticated cmd = (NotAuthenticated)obj;
