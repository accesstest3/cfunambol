...
/**
 * Fake streaming item using in junit
 * @version $Id$
 */
public class FakeStreamingSyncItem extends StreamingSyncItem {
    ...
    /**
     * Creates a copy of the FakeStreamingSyncItem object
     * The new FakeStreamingSyncItem and the original one have a reference to the same
