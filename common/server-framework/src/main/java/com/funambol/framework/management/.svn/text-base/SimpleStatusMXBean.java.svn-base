...
/**
 * A simple implementation of the StatusMXBean interface
 *
 * @version $Id: SimpleStatusMXBean.java,v 1.5 2007-11-28 11:15:37 nichele Exp $
 */
public class SimpleStatusMXBean extends AbstractStatusMXBean
