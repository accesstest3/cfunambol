...
/**
 * Possible values for convert date policy
 * @version $Id: ConvertDatePolicy.java,v 1.2 2007-11-28 11:15:38 nichele Exp $
 */
public interface ConvertDatePolicy {

    /**
     * Possible values for property convertDatePolicy:
     */
