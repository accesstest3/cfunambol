 ...
 *
 * A DataTransformer is a component that given some data in some format
...
public abstract class DataTransformer {
    ...
    /** Creates a new instance of DataTransformer */
    ...
    public abstract byte[] transform(byte[] data, TransformationInfo info)
