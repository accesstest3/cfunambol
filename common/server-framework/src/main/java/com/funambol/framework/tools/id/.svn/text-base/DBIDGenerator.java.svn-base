 ...
 * <code>com.funambol.framework.tools.id.DBIDGeneratorFactory</code> should be used,
 * otherwise your class that needs a DBIDGenerator should keep a
 * static reference to it.
 *
 * @version $Id: DBIDGenerator.java,v 1.3 2007-11-28 11:16:10 nichele Exp $
 */
public class DBIDGenerator implements java.io.Serializable {
     ...
     * @throws com.funambol.framework.tools.id.DBIDGeneratorException if an error occurs
     */
