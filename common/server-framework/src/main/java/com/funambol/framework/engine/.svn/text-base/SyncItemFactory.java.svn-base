...
/**
 * Responsibility: create new AbstractSyncItem instances
 * @version $Id$
 */
public interface SyncItemFactory {

    /**
     * Factory method to create an AbstractSyncItem
     * @param syncSource The SyncSource referred to the SyncItem 
     * @param key The SyncItem key
     * @return a AbstractSyncItem
     */
