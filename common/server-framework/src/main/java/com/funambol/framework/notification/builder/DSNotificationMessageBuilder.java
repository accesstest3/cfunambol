...
/**
 * The implementations of this interface must build the notification message.
 *
 * @version $Id: DSNotificationMessageBuilder.java,v 1.2 2007-11-28 11:15:50 nichele Exp $
 */
public interface DSNotificationMessageBuilder {
     ...
     * @param protocolVersion the version of SyncML protocol
     *
     * @return the message
