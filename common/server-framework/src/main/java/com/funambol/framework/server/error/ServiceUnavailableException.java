...
/**
 * Exceptions used to notify "service unavailable" (CODE: 503)
 * @version $Id: ServiceUnavailableException.java,v 1.2 2007-11-28 11:15:59 nichele Exp $
 */
public class ServiceUnavailableException extends ServerException {
    ...
    public ServiceUnavailableException(final String msg, final Throwable cause){
        super(StatusCode.SERVICE_UNAVAILABLE, msg, cause);
    }
}
