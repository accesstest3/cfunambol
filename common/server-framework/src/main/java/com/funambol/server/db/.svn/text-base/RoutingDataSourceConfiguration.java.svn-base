...
/**
 * Used to configure a RoutingDataSource.
 * <br/>
 * See <code>DataSourceFactory</code>
 *
 * @version $Id: RoutingDataSourceConfiguration.java,v 1.3 2008-06-14 14:39:02 nichele Exp $
 */
public class RoutingDataSourceConfiguration extends DataSourceConfiguration {

    // -------------------------------------------------------------- Properties

    /** The configured partitioning criteria */
    ...
    /** The configured partition configuration loader */
    ...
    public RoutingDataSourceConfiguration(Properties prop,
                                          PartitioningCriteria partitioningCriteria,
                                          PartitionConfigurationLoader partitionConfigurationLoader) {
    ...
    @Override
    public RoutingDataSourceConfiguration clone() {
        if (configurationProperties == null) {
            return null;
        }
        return new RoutingDataSourceConfiguration((Properties) configurationProperties.clone(),
                                                  partitioningCriteria,
                                                  partitionConfigurationLoader);
    }
}
