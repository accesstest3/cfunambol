 ...
 *
 * @version $Id: BaseConverter.java,v 1.8 2008-08-25 14:45:51 mauro Exp $
 */
public abstract class BaseConverter implements ConverterUnit {
    ...
    throws ConverterException {
        ...
        try {
            ...
            throw new ConverterException("Error composing VCard component ", e);
        }
    ...
    throws ConverterException {
        ...
        try {
            ...
            throw new ConverterException("Error composing iCalendar component ", e);
        }
        return result;
    }
