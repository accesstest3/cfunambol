...
public class VCalendarConverter extends BaseConverter {
    ...
    public Calendar vcalendar2calendar(VCalendar vcal)
     throws ConverterException {
        ...
        if (xv) {
            com.funambol.common.pim.model.Property tz = vcal.getProperty("TZ");
            List<com.funambol.common.pim.model.Property> daylightList =
        ...
        if (timeZones.isEmpty()) {
            ...
            List<com.funambol.common.pim.model.Property> dtStart =
                    new ArrayList<com.funambol.common.pim.model.Property>(1);
            dtStart.add(vcc.getProperty("DTSTART"));
            dtStartTimeZone = matchTimeZone(dtStart, timeZones);
            List<com.funambol.common.pim.model.Property> dtEnd =
                    new ArrayList<com.funambol.common.pim.model.Property>(2);
        ...
        if (xv && !forceClientLocalTime) {
            ...
            if ((id != null) && (id.length() != 0)) {
                ...
                TimeZoneHelper tz = new CachedTimeZoneHelper(id         ,
                                                             interval[0],
                                                             interval[1]);
                for (com.funambol.common.pim.model.Property xvCalendarProperty :
    ...
    protected Map<String, String> getParameters(
            com.funambol.common.pim.model.Property property) {
     ...
     */
    protected com.funambol.common.pim.model.Property composeField(String label,
                                                            Property property ,
                                                            boolean xvCalendar) {
        ...
        com.funambol.common.pim.model.Property out = null;
        String name            = label;
        boolean xtag           = false;
        ...
        QuotedPrintableCodec qpc = null;

        // Check if QP-encoding is needed (iCalendar is never QP-encoded)
        if (xvCalendar && isQPProperty(name)) {
            try {
                qpc = new QuotedPrintableCodec(charset);
                value = qpc.encode(value);
                if (value.indexOf('=') == -1) {
                    qpc = null; // The encoding was useless
                }
        ...
        if (qpc != null) { // QP codec has been used to encode the value
            ...
            params.add(new Parameter("CHARSET", qpc.getCharSetName()));
        ...
        if (value != null){
            out = new com.funambol.common.pim.model.Property(
    ...
    private void setCommonProperties(VCalendar vcal, Calendar cal, boolean xvCalendar)
        ...
        if (cal.getProdId() != null){
            com.funambol.common.pim.model.Property prodId =
        ...
        if (cal.getVersion() != null){
            com.funambol.common.pim.model.Property version =
        ...
        if (cal.getCalScale() != null){
            com.funambol.common.pim.model.Property calscale =
        ...
        if (cal.getMethod() != null){
            com.funambol.common.pim.model.Property method =
     ...
     * @return
     */
    protected com.funambol.common.pim.model.Property composeDateTimeField(
        String               label            ,
    ...
    protected com.funambol.common.pim.model.Property composeDateTimeField(
        ...
        com.funambol.common.pim.model.Property p =
    ...
    protected Property decodeField(
        ...
        if ((encodingParameter != null) &&
            ...
            QuotedPrintableCodec qpc = new QuotedPrintableCodec(fieldCharset);
            try {
    ...
    private TimeZone matchTimeZone(
            ...
            Map<String, TimeZoneHelper> timeZones) {
        for (com.funambol.common.pim.model.Property property : properties) {
            if (property != null) {
    ...
    private void replaceInDateTime(com.funambol.common.pim.model.Property p, 
    ...
    private void removeTime(com.funambol.common.pim.model.Property p) 
    throws ConverterException {
