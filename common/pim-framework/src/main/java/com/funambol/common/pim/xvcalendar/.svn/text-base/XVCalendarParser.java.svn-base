...
public class XVCalendarParser {

    private InputStream is;

    public XVCalendarParser(InputStream is) {
        this.is = is;
    }

    public VCalendar XVCalendar() throws ParseException {

        VCalendar calendar = new VCalendar();
        XVCalendarSyntaxParserListener listener = new XVCalendarSyntaxParserListenerImpl(calendar);
