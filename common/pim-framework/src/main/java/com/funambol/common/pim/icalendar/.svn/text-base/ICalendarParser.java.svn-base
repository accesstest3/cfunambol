...
public class ICalendarParser {
    ...
    public ICalendarParser(InputStream is) {
        this.is = is;
    }

    public VCalendar ICalendar() throws ParseException {

        VCalendar calendar = new VCalendar();
        ICalendarSyntaxParserListener listener = new ICalendarSyntaxParserListenerImpl(calendar);
