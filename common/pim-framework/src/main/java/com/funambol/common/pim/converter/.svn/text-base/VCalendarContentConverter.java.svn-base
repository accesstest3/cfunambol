...
public class VCalendarContentConverter extends VCalendarConverter  {
    ...
    throws ConverterException {
        ...
        String accessClass;
        com.funambol.common.pim.model.Property tmpClass =
        ...
        com.funambol.common.pim.model.Property msCdoBusyStatus = 
        ...
        if (rrule != null && rrule.getPropertyValueAsString().length() != 0) {
            try {
                ...
                for (com.funambol.common.pim.model.Property rdateProperty : rdates) {
                ...
                for (com.funambol.common.pim.model.Property exdateProperty : exdates) {
    ...
    private Reminder convertVAlarmToReminder(VAlarm valarm               ,
        ...
        try {
            com.funambol.common.pim.model.Property triggerProperty = 
            ...
            com.funambol.common.pim.model.Property repeatProperty = 
            ...
            com.funambol.common.pim.model.Property durationProperty = 
            ...
            com.funambol.common.pim.model.Property actionProperty = 
                    valarm.getProperty("ACTION");
            if ((actionProperty != null) && 
                ("AUDIO".equals(actionProperty.getValue()))) {
                com.funambol.common.pim.model.Property attachProperty = 
    ...
    public long[] extractInterval(VCalendarContent vcc) {
        ...
        if (vcc.getProperty("RRULE") != null) {
            ...
            List<com.funambol.common.pim.model.Property> rdates =
                    vcc.getProperties("RDATE");
            for (com.funambol.common.pim.model.Property property : rdates) {
