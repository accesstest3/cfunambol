 ...
 *
 * @version $Id: BaseThreadFactory.java,v 1.5 2007-11-28 11:14:43 nichele Exp $
 */
public class BaseThreadFactory implements ThreadFactory {

    private static final String BASE_PREFIX = "PushListener-";
    ...
    public BaseThreadFactory(String prefix) {
        ...
        this.namePrefix = BASE_PREFIX + prefix + "-thread-";
    }
