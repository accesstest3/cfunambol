...
/**
 * Provided an empty implementation of all methods defined in the PushListenerPlugin
 * interface. It can be used as base class for a concrete plugin implementation
 *
 * @version $Id: PushListenerPluginAdapter.java,v 1.2 2007-11-28 11:14:54 nichele Exp $
 */
public class PushListenerPluginAdapter implements PushListenerPlugin {

    // ------------------------------------------------------------ Constructors
    /** Creates a new instance of PushListenerPluginAdapter */
    public PushListenerPluginAdapter() {
    }

    // ---------------------------------------------------------- Public methods

    /**
     * See {@link PushListenerPlugin}
     */
