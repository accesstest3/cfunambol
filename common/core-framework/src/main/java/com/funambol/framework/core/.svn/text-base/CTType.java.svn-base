 ...
 *
 *
 * @version $Id: CTType.java,v 1.2 2007/07/30 22:10:05 stefano_fornari Exp $
 */
public class CTType implements java.io.Serializable {
    ...
    /**
     * Creates a new CTType object with the given information
     *
    ...
    public CTType(final String ctType,
                  final CTProperty[] properties ) {
        setCTType(ctType);
        setCTProperties(properties);
    }
     ...
     */
    public CTType(final String ctType,
                  final ArrayList ctProperties ) {
        setCTType(ctType);
        setCTPropParams(ctProperties);
    }
     ...
     * @param ctPropParams array of content type properties and parameters
     *
     * @deprecated use setCTProperties() instead
     *
     */
    public void setCTPropParams(ArrayList ctProperties) {
        if (ctProperties == null) {
            throw new IllegalArgumentException("ctPropParams cannot be null");
        }
        this.ctProperties.clear();
        this.ctProperties.addAll(ctProperties);
    }
}
