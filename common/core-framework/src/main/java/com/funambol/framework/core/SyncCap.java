 ...
 * @see DataStore
 *
 * @version $Id: SyncCap.java,v 1.2 2007/07/30 22:10:05 stefano_fornari Exp $
 */
public class SyncCap implements java.io.Serializable {
     ...
     * @param syncTypes the array of SyncType
     */
    public void setSyncType(ArrayList syncTypes) {
        if (syncTypes == null || syncTypes.size() == 0) {
            throw new IllegalArgumentException("syncTypes cannot be null or empty");
        }
        this.syncTypes.clear();
        this.syncTypes.addAll(syncTypes);
    }
}
