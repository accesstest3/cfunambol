...
/**
 * This class supplies some methods to escape / unescape special chars
 * according XML specifications
 *
 * @version  $Id: Entities.java,v 1.2 2007-11-28 11:13:24 nichele Exp $
 *
 */
class Entities {
    ...
    public String escape(String str) {
        ...
        buf = new StringBuilder((int)(str.length() * 1.05));   // increasing of 5%
    ...
    public String unescape(String str) {
        ...
        buf = new StringBuilder(str.length()); // the result is <= or the original len
     ...
     * @return A escaped <code>String</code>.
     */
    public String escapeBasic(String str) {
        char         ch          = ' ' ;
        String       entityName  = null;
        StringBuilder buf        = null ;
