...
/**
 * @version $Id: BeanNotFoundException.java,v 1.2 2007-11-28 11:13:37 nichele Exp $
 */
public class BeanNotFoundException extends BeanException {
    ...
    public BeanNotFoundException(String beanName, ClassLoader classLoader) {
        super( "Resource "
             + beanName
             + " not found"
             + " with "
             + ((classLoader == null) ? "default calss loader" 
