 ...
 *
 * @deprecated use CTInfo instead
 *
 * @version $Id: ContentTypeInfo.java,v 1.6 2007/06/15 14:43:36 luigiafassina Exp $
 */
public class ContentTypeInfo implements java.io.Serializable {
