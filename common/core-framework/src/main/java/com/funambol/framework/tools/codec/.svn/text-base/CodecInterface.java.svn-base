...
/**
 *
 * @version $Id: CodecInterface.java,v 1.2 2007-11-28 11:13:37 nichele Exp $
 */
public interface CodecInterface {
    ...
    public String decode(String str) throws CodecException, UnsupportedEncodingException;
}
