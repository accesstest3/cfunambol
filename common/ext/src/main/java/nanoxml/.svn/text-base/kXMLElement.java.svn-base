 ...
 *
 * $Id: kXMLElement.java,v 1.2 2008-05-14 16:22:03 nichele Exp $
 *
 *
...
public class kXMLElement {
    ...
    private void processContents(char[] input,
        ...
        if (!skipLeadingWhitespace) {
            contents = new String(input, contentOffset, contentSize);
            return;
        }
    ...
    public void write(Writer writer,
        ...
        if ((contents != null) && (contents.length() > 0)) {
            ...
            out.println('>');
            Enumeration enumeration = enumerateChildren();

            while (enumeration.hasMoreElements()) {
                kXMLElement child = (kXMLElement) (enumeration.nextElement());
