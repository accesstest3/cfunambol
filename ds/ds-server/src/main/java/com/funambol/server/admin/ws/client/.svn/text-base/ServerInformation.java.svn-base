...
/**
 * Contains the information required to call a ds-server ws method.
 * @version $Id: ServerInformation.java,v 1.1 2008-02-24 14:43:46 stefano_fornari Exp $
 */
public class ServerInformation {
     ...
     */
    public ServerInformation(String url, String user, String pwd) {
        this.setUrl(url);
        if (user == null) {
