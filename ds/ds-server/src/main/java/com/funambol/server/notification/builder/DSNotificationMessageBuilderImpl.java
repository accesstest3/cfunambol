...
import com.funambol.framework.notification.builder.*;

/**
 * This class is an implementation of DSNotificationMessageBuilder
 *
 * @see DSNotificationMessageBuilder
 *
 * @version $Id: DSNotificationMessageBuilderImpl.java,v 1.1.1.1 2008-02-21 23:35:52 stefano_fornari Exp $
 */
public class DSNotificationMessageBuilderImpl
implements DSNotificationMessageBuilder {

    // -------------------------------------------------------------- Constructor
    public DSNotificationMessageBuilderImpl() {
    }
    ...
    throws NotificationException {
        ...
        header.setInitiator(HeaderMessage.INITIATOR_SERVER);

        header.setUiMode(uimode);
        ...
        //body
        BodyMessage bodyMessage = new DSBodyMessage(alerts);
        ...
        return new Message(Message.Type.STANDARD_1_2_NOTIFICATION_MESSAGE_TYPE, msg);
    }
