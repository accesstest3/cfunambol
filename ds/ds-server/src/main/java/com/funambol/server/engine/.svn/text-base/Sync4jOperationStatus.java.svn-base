...
/**
 * This class represents the status of a modification command excecuted by Funambol.
 * The main difference between this and a normal <i>SyncoperationStatus</i> is
 * that a <i>Sync4jOperationStatus</i> is associated to a SyncML command (such as
 * &lt;Add&gt;, &lt;Delete&gt;, etc).
 *
 * @version $Id: Sync4jOperationStatus.java,v 1.1.1.1 2008-02-21 23:35:46 stefano_fornari Exp $
 */
public class Sync4jOperationStatus extends SyncOperationStatus {
    ...
    public Sync4jOperationStatus(SyncOperation       operation ,
                                 ...
                                 int                 statusCode) {
        super(operation, syncSource, statusCode);
        this.cmd = cmd;
    }
    ...
    public Sync4jOperationStatus(SyncOperation operation ,
                                 SyncSource    syncSource) {
        this(operation, syncSource, null, -1);
    }
}
