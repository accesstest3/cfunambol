 ...
 *
 * @version $Id: Sync4jOperationStatusDelete.java,v 1.1.1.1 2008-02-21 23:35:46 stefano_fornari Exp $
 */
public class Sync4jOperationStatusDelete extends Sync4jOperationStatus {

    /** Creates a new instance of Sync4jOperationStatusDelete */
    public Sync4jOperationStatusDelete(SyncOperation       operation ,
                                       SyncSource          syncSource,
                                       ModificationCommand cmd       ) {
        super(operation, syncSource, cmd, StatusCode.OK);
    }
    ...
    public Sync4jOperationStatusDelete(SyncOperation       operation ,
                                       ...
                                       ModificationCommand cmd       ,
                                       int                 statusCode) {
        super(operation, syncSource, cmd, statusCode);
    }
