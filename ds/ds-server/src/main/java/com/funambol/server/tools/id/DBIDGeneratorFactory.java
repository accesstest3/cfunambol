 ...
 *
 * @version $Id: DBIDGeneratorFactory.java,v 1.1.1.1 2008-02-21 23:36:03 stefano_fornari Exp $
 */
public class DBIDGeneratorFactory {
     ...
     * com.funambol.server.tools.id.DBIDGenerator</code> with your datasource.</b>
