<%-- $Id: viewtask.jsp,v 1.6 2007-10-26 08:12:09 luigiafassina Exp $ --%>
...
function setOperation(operation) {
 ...
 if (operation=="3") {
  if (!confirm("<fmt:message key="msg.confirmDeleteTask"/>")) {
   return;
  }
...
<form name="info" method="POST" action="main.jsp" accept-charset="utf-8">
  ...
  <TABLE cellspacing="0" cellpadding="4" width="80%" align="center">
   <TR class="teta">
    <TD class="teta" colspan="2" align="center">
     <FONT class="teta"><b><fmt:message key="msg.notfoundTask"/></b></FONT>
    </TD>
   </TR>
 ...
 <TABLE cellspacing="0" cellpadding="4" width="80%" align="center">
   ...
   <TR class="teta">
    <TD class="teta">
        <FONT class="teta"><fmt:message key="msg.dtendTask"/>&nbsp</FONT>
    </TD>
    <TD class="teta">
   ...
   <TR class="teta">
    ...
    <TD class="teta">
        <input type="text" style="width:100%" name="percentcomplete"
               value="<c:out value="${item.percentcomplete}"/>">
    </TD>
   </TR>
   ...
   <TR class="teta">
    ...
    <TD class="teta">
        <input type="text" maxlength="2" size="2" name="ddcompleted"
               value="<c:out value="${item.ddcompleted}"/>">
        /
        <input type="text" maxlength="2" size="2" name="mmcompleted"
               value="<c:out value="${item.mmcompleted}"/>">
        /
        <input type="text" maxlength="4" size="4" name="yyyycompleted"
               value="<c:out value="${item.yyyycompleted}"/>">
    </TD>
   </TR>
