<%-- $Id: listtask.jsp,v 1.1 2007-03-01 14:18:27 luigiafassina Exp $ --%>
...
function showCalendar(id) {
  window.location.href = 'main.jsp?main=main&operation=VIEW&type=task&item=' + id;
}
</script>
...
<TABLE cellspacing="0" cellpadding="4" width="80%" align="center">
  <TR class="teta">
      <TD class="teta">
          <FONT class="teta">
              <b><fmt:message key="msg.titleTask"/></b>
          </FONT>
      </TD>
  </TR>
  <TR><TD>&nbsp;</TD></TR>
  ...
  <TR class="teta">
      <TD class="teta">
          <FONT class="teta">
              <fmt:message key="msg.subtitleTask">
                  <fmt:param value="main.jsp?main=main&operation=ADD&type=task"/>
              </fmt:message>
          </FONT>
      </TD>
  </TR>
