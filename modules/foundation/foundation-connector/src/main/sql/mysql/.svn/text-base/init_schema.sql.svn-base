...
--
-- @version $Id: init_schema.sql,v 1.1.1.1 2008-03-20 21:38:29 stefano_fornari Exp $
--
...
values('foundation','foundation','Funambol Foundation Connector');
...
delete from fnbl_connector_source_type where connector='foundation' and sourcetype='config-foundation';
insert into fnbl_connector_source_type(connector, sourcetype) 
...
or sync_source='stask' or sync_source='configuration');
