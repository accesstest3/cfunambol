...
/**
 * This exception is raised when a file to be added exceeds the per-user storage
 * quota allowed for that sync source.
 *
 * @version $Id$
 */
public class QuotaOverflowException extends DAOException {
    ...
    public QuotaOverflowException(String message, long usedQuota, long maxQuota, long itemSize) {
        super(message);
