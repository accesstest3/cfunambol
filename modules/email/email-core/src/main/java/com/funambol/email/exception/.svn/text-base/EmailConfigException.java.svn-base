...
/**
 *
 * @version $Id: EmailConfigException.java,v 1.1 2008-03-25 11:28:17 gbmiglia Exp $
 */
public class EmailConfigException extends Exception {

    /**
     * Creates a new instance of <code>EmailConfigException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>EmailConfigException</code> with
