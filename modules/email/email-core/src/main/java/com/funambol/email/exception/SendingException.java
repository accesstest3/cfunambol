 ...
 *
 * @version $Id: SendingException.java,v 1.1 2008-03-25 11:25:32 gbmiglia Exp $
 */
public class SendingException extends Exception {

    /**
     * Creates a new instance of <code>SendingException</code> without
     * detail message.
     */
     ...
     * @param cause Throwable
     */
    public SendingException(String msg, Throwable cause) {
        super(msg, cause);
    }
