...
/**
 *
 * @version $Id: EntityException.java,v 1.1 2008-03-25 11:28:18 gbmiglia Exp $
 */
public class EntityException extends SyncException {
     ...
     * @param msg the detail message.
     */
    public EntityException(String msg, int statusCode) {
        super(msg, null, statusCode);
