 ...
 * <br/>
 * This panel includes the following fields for specifying the user searching
 * criteria : userName, firstname, lastname, email
 *
 * @version $Id: FormSearchUserPanel.java,v 1.1 2008-03-25 11:28:21 gbmiglia Exp $
 *
 **/
public class FormSearchUserPanel extends JPanel {
    ...
    public FormSearchUserPanel() {
        try {
            ...
            Log.error("Error creating Search Users Panel " + getClass().getName(), e);
        }
    }
    ...
    private void init() throws Exception {
        ...
        panelName.setText("Search Users");
        ...
        jBSearch.setBounds(new Rectangle(350, 53, 88, 23));
        jBSearch.setText("Search");
        jBSearch.setActionCommand(Constants.ACTION_COMMAND_SEARCH_USER);

        jBReset.setBounds(new Rectangle(350, 80, 88, 23));
