...
/**
 * This class implements the logic behind any single inbox-listener task.
 * <p>
 * At configuration time, the user to monitor is read from the IL registry entry.
 * <p>
 ...
 * sync, a notification message is sent.
 * <p>
 * In order to handle all cases, a device will be notified only if it has completed
 * at least once a synchronization.
 * <p>
 *
 * All parameters are configurable via xml file (syncSourceEmail, contentTypeEmail)
 *
 * @version $Id: InboxListenerScheduledTask.java,v 1.4 2008-05-18 15:01:51 nichele Exp $
 */
public class InboxListenerScheduledTask implements ScheduledTask {
     ...
     * configuration parameters read from the table <code>
     * fnbl_push_listener_registry</code>.
        ...
        try {
            ...
            if (msa != null){
                ...
                ilmanager.init(msa, saveSubject, saveSender, 
                        timeoutStore, timeoutConnection, checkCertificates);
