 ...
 *
 *
 * @version $Id: IDAccountProvider.java,v 1.1.1.1 2007-12-11 08:17:19 nichele Exp $
 */
public class IDAccountProvider implements IMailServerAccountProvider {
    ...
    public IDAccountProvider(String pushRegistryTableName){
