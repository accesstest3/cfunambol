...
/**
 * Example task
 * @version $Id: HelloWorldTask.java 35046 2010-07-14 14:22:58Z pfernandez $
 */
public class HelloWorldTask implements Task {
    ...
    public void execute() throws TaskException {
        log.trace("execute  " + HelloWorldTask.class.getName());
    }

    public long getPeriod() {
        log.trace("getPeriod for " + HelloWorldTask.class.getName());
        return 0;
    }

    public void configure(TaskConfiguration conf) {
        log.trace("configuring  " + HelloWorldTask.class.getName());
    }
}
