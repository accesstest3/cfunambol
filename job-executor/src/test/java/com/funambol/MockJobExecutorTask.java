...
/**
 *
 * @version $Id: MockJobExecutorTask.java 35046 2010-07-14 14:22:58Z pfernandez $
 */
public class MockJobExecutorTask implements Task {

    public static HashMap<String, Object> map = new HashMap<String, Object>();
    public static boolean executed = false;

    public void configure(TaskConfiguration conf) throws TaskException {
        map = (HashMap<String, Object>) conf.getProperties();
    }

    public void execute() throws TaskException {
        MockJobExecutorTask.executed = true;
    }
